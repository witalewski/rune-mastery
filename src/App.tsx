...
function App() {
  const [paths, setPaths] = useState([
    ...
    },
    {
      ...
      name: "Talent Path 2",
      talents: [
        { id: "talent-1", name: "Talent 1", selected: true, iconIndex: 4 },
        { id: "talent-2", name: "Talent 2", selected: false, iconIndex: 5 },
        { id: "talent-3", name: "Talent 3", selected: false, iconIndex: 6 },
        { id: "talent-4", name: "Talent 4", selected: false, iconIndex: 7 },
